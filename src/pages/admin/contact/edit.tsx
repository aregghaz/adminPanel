...
const ContactEdit: React.FC<IProductsList> = () => {
    ...
    const fields: Array<any> = [
        ...
        {name: "contact_skype", type: "input", label: "contact_skype", placeholder: "contact_skype"},
        {name: "contact_viber", type: "input", label: "contact_viber", placeholder: "contact_viber"},
